...
describe('HTMLUglify', function() {
  ...
  describe('#process', function() {
    it('uglifies style and html', function(done) {
      var html = htmlUglify.process("<style>.test#other{}</style><p class='test' id='other'></p>").html;
      assert.equal(html, '<style>.xz#wk{}</style><p class="xz" id="wk"></p>');
    });
    // it('uglifies differently with a different salt', function() {
    //   var html = htmlUglify.process("<style>.demo_class#andID{color: red}</style><div class='demo_class' id='andID'>Welcome to HTML Uglify</div>", {salt: 'other'});
    ...
    //   var html = htmlUglify.process("<style>#noform { color: red; } .withform{ color: red } #other{ color: red; }</style><div id='noform' class='noform'>noform</div><div class='withform'>withform</div><div id='other'>other</div>", {salt: 'use the force harry', whitelist: whitelist});
