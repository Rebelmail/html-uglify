...
describe('HtmlUglify', function() {
  describe('#constructor', function() {
    it('should return an access', function() {
      assert.isObject(HtmlUglify.access);
    });
    it('should return an access.used', function() {
      assert.isArray(HtmlUglify.access.used.ids);
    });
    it('should return a forCss', function() {
      assert.isObject(HtmlUglify.access.forCSS);
    });
    it('should return an idmapper', function() {
      assert.equal(HtmlUglify.access.idmapper, 0);
    });
    it('should return a classmapper', function() {
      assert.equal(HtmlUglify.access.classmapper, 0);
    });
  });
  ...
  describe('#uglify', function() {
    it('uglifies style and html', function() {
      var html = HtmlUglify.uglify("<style>.demo_class#andID{color: red}</style><div class='demo_class' id='andID'>Welcome to HTML Uglifier</div>");
